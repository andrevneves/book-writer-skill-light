...
|---|-------|---------|-----------------|
| **Prologue** | *{{TITLE}}* | {{Why this title — symbolism, wordplay, dual meanings, cultural references}} | {{What happens in this chapter, key turning points, how title connects to events}} |
| **1** | *{{TITLE}}* | {{Meaning}} | {{Story Connection}} |
| **2** | *{{TITLE}}* | {{Meaning}} | {{Story Connection}} |
| **3** | *{{TITLE}}* | {{Meaning}} | {{Story Connection}} |
<!-- Continue for all chapters... -->
| **Epilogue** | *{{TITLE}}* | {{Meaning}} | {{Story Connection}} |

---

## Title Pattern

{{1-3 sentences analyzing how the titles evolve thematically across the book — e.g. from concrete to abstract, from personal to universal, mirroring the protagonist's arc.}}
...
| # | Title | Meaning | Story Connection |
|---|-------|---------|-----------------|
| **Prologue** | *{{TITLE}}* | {{Meaning}} | {{Story Connection}} |
| **1** | *{{TITLE}}* | {{Meaning}} | {{Story Connection}} |
| **2** | *{{TITLE}}* | {{Meaning}} | {{Story Connection}} |

---

## PART II: {{PART_NAME}} ({{time period or theme}})

| # | Title | Meaning | Story Connection |
|---|-------|---------|-----------------|
| **N** | *{{TITLE}}* | {{Meaning}} | {{Story Connection}} |

---

## PART III: {{PART_NAME}} ({{time period or theme}})
...
{{Analysis of how titles shift across parts — e.g. "Part I titles are grounded and historical; Part III titles are transcendent and mythological, mirroring the protagonist's transformation."}}
-->
